...
cl = CYBERTK.LINE()
cl.login(token="Ep5XpfnBGhUGLgMQYJIa.GAesrUIrTvfco6foBAHf6G.oGywCD31MtreMwF2s6UH67Yz/mwfTcUAbpVmD+s0AEw=")
cl.loginResult()
...
Bots=[mid]
admin=["u101abf0d47f6027aa15c772fedf12dde"]
creator=["u101abf0d47f6027aa15c772fedf12dde"]
wait = {
    'contact':False,
    'autoJoin':True,
