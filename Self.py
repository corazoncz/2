...
cl = CYBERTK.LINE()
cl.login(token="EprUeHp0kI1VjYPymn2a.GAesrUIrTvfco6foBAHf6G.IzBoo7aZ2AbG7ixZGpqSSHNbIO606mw1fHRk5JWiiUE=")
cl.loginResult()
...
admin=["u446015c6dce1ba353408e4f01477abc0"]
creator=["u446015c6dce1ba353408e4f01477abc0"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks For Add ☆ TK  BOT NONG  ☆\n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~nong2614",
    "lang":"JP",
    "comment":"Thanks For Add ☆ TK  BOT NONG  ☆\nv\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~nong2614",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#------------------NOTIFIED_READ_MESSAGE----------------#
        ...
        if op.type == 17:
                ...
                cb = Message()
                cb.to = op.param1
                cb.text = random.choice(KAC).getContact(op.param2).displayName + " \n🔜ยินดีต้อนรับเข้าสู่...\n" + group.name + "\n\n📲เข้ามาแล้วอย่ารีบออกน้า\n👀อยู่ส่องกันก่อนได้นะ\n🏡บ้านนี้ชัวร์แน่นอนจ้า\n⏰ส่งยอดไว มีเงินสำรอง\n❌ไม่บิน ไม่แขวนยอดแน่นอน💯" + "\n\n👤By บอทโหน่ง\n📲ติดต่อเกี่ยวกับบอท :  line://ti/p/~nong1426"
